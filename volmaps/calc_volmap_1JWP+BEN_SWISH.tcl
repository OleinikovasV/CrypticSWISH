...
set trajfile /home/vladas/mnt/IB-server/storage/project_UCB/TEM1/HREX+FRAGS/TEM1+BEN/traj_full_fixed/traj${i}_aligned_full.xtc
...
set outfile density-DM_1JWP+BEN_SWISH-traj${i}_frames-$begin-$end.dx
